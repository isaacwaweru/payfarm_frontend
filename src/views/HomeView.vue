    ...
    <v-layout class="app_user_home" column wrap>
      <v-flex xs12 md3
        ><section class="empoweringFarming">
          <!-- <video control class="video__intro">
            <source src="../assets/video/intro.mp4" type="video/mp4" />
          </video> -->
          <iframe
            class="video__intro"
            src="https://www.youtube.com/embed/DxECwPfgyzI"
          >
          </iframe>
        </section>
                ...
                <div
                  :class="{
                    'card-1-r mt-16 mb-5 ml-auto mr-auto wdt_card-1':
                      $vuetify.breakpoint.smAndDown,
                    'card-1-r mt-16 mb-5 wdt_card-1':
                ...
                <div
                  :class="{
                    'card-1-r-r mt-16 mb-5 ml-auto mr-auto wdt_card-1':
                      $vuetify.breakpoint.smAndDown,
                    'card-1-r-r mt-16 mb-5 wdt_card-1':
                      $vuetify.breakpoint.mdAndUp,
                  }"
                >
                  <div class="card-2 wdt_card-2">
        ...
        <div class="footer-1 bg_position">
          <video
            src="../assets/video/CattleBgVideo.mp4"
            loop
            muted
            autoplay
          ></video>
          ...
          <v-card
            :class="{
              'form-mobile mt-1 mr-1 ml-1 mb-1': $vuetify.breakpoint.smAndDown,
          ...
          >
            ...
            <div>
              <form class="ml-8 mr-8 wdt-form" v-on:submit.prevent="submitForm">
                <h4>Email Address</h4>
                <v-text-field
                  v-model="email"
                  label="Enter Email"
                ...
                <v-btn type="submit" color="#556EE6" dark width="100%">
                  {{ isLoading }}
                </v-btn>
